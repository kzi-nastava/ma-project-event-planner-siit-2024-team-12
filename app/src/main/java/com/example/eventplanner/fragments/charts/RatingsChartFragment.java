...
public class RatingsChartFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_ratings_chart, container, false);
        ...
        pdfBtn.setOnClickListener(v -> {
            if (!eventList.isEmpty()) {
                ...
                Toast.makeText(requireActivity(), "Loading data, please wait...", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void loadEventRatings() {
        ...
        call.enqueue(new Callback<ArrayList<EventRatingsDTO>>() {
            ...
            public void onFailure(Call<ArrayList<EventRatingsDTO>> call, Throwable t) {
                Toast.makeText(requireActivity(), "Failed to load event ratings!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void openGeneratedPDF(String filePath) {
        ...
        if (file.exists()) {
            ...
            Toast.makeText(requireActivity(), "PDF not found!", Toast.LENGTH_LONG).show();
        }
    }
